...
import (
	...
	"git.marconi.org/marconiprotocol/go-methereum-lite/consensus/clique"
	"git.marconi.org/marconiprotocol/go-methereum-lite/consensus/ethash"
	"git.marconi.org/marconiprotocol/go-methereum-lite/core"
	"git.marconi.org/marconiprotocol/go-methereum-lite/core/bloombits"
	...
	"git.marconi.org/marconiprotocol/go-methereum-lite/eth/filters"
	"git.marconi.org/marconiprotocol/go-methereum-lite/eth/gasprice"
...
func (s *Ethereum) StartMining(threads int) error {
  return fmt.Errorf("mining is disabled in this binary")
}
