...
//
// https://gitlab.neji.vm.tc/marconi/wiki/wiki/JSON-RPC#eth_newpendingtransactionfilter
...
//
// https://gitlab.neji.vm.tc/marconi/wiki/wiki/JSON-RPC#eth_newblockfilter
...
//
// https://gitlab.neji.vm.tc/marconi/wiki/wiki/JSON-RPC#eth_newfilter
...
//
// https://gitlab.neji.vm.tc/marconi/wiki/wiki/JSON-RPC#eth_getlogs
...
//
// https://gitlab.neji.vm.tc/marconi/wiki/wiki/JSON-RPC#eth_uninstallfilter
...
//
// https://gitlab.neji.vm.tc/marconi/wiki/wiki/JSON-RPC#eth_getfilterlogs
...
//
// https://gitlab.neji.vm.tc/marconi/wiki/wiki/JSON-RPC#eth_getfilterchanges
