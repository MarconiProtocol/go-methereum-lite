...
func TestAddressHexChecksum(t *testing.T) {
	var tests = []struct {
		...
		// Test cases from https://gitlab.neji.vm.tc/marconi/EIPs/blob/master/EIPS/eip-55.md#specification
...
func TestMixedcaseAccount_Address(t *testing.T) {
	...
	// https://gitlab.neji.vm.tc/marconi/EIPs/blob/master/EIPS/eip-55.md
