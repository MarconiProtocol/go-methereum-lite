...
Building Swarm requires Go (version 1.10 or later).
    ...
    go get -d github.com/MarconiProtocol/go-methereum-lite

    go install github.com/MarconiProtocol/go-methereum-lite/cmd/swarm
...
You must have your working copy under `$GOPATH/src/github.com/MarconiProtocol/go-methereum-lite`.
...
```
git clone git@github.com:nirname/go-ethereum.git $GOPATH/src/github.com/MarconiProtocol/go-methereum-lite
```
...
```
stateth --rm --grafana-dashboards-folder $GOPATH/src/github.com/MarconiProtocol/go-methereum-lite/swarm/grafana_dashboards --influxdb-database metrics
```
