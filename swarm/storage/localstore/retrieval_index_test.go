...
//
// # go test -benchmem -run=none git.marconi.org/marconiprotocol/go-methereum-lite/swarm/storage/localstore -bench BenchmarkRetrievalIndexes -v
// goos: darwin
// goarch: amd64
...
//
// go test -benchmem -run=none git.marconi.org/marconiprotocol/go-methereum-lite/swarm/storage/localstore -bench BenchmarkUpload -v
// goos: darwin
// goarch: amd64
// pkg: git.marconi.org/marconiprotocol/go-methereum-lite/swarm/storage/localstore
