...
import (
	...
	"git.marconi.org/marconiprotocol/go-methereum-lite/swarm/shed"
...
//
// # go test -benchmem -run=none git.marconi.org/marconiprotocol/go-methereum-lite/swarm/storage/localstore -bench BenchmarkNew -v -timeout 20m
// goos: darwin
// goarch: amd64
