...
import (
	...
	"github.com/MarconiProtocol/go-methereum-lite/swarm/shed"
...
//
// # go test -benchmem -run=none github.com/MarconiProtocol/go-methereum-lite/swarm/storage/localstore -bench BenchmarkNew -v -timeout 20m
// goos: darwin
// goarch: amd64
