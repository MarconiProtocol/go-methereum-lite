...
import (
	...
	math2 "git.marconi.org/marconiprotocol/go-methereum-lite/common/math"
...
func newAlethGenesisSpec(network string, genesis *core.Genesis) (*alethGenesisSpec, error) {
	...
	spec.Params.BlockReward = (*hexutil.Big)(ethash.DefaultBlockReward)
...
func newParityChainSpec(network string, genesis *core.Genesis, bootnodes []string) (*parityChainSpec, error) {
	...
	spec.Engine.Ethash.Params.BlockReward["0x0"] = hexutil.EncodeBig(ethash.DefaultBlockReward)
...
func (spec *parityChainSpec) setByzantium(num *big.Int) {
	spec.Engine.Ethash.Params.BlockReward[hexutil.EncodeBig(num)] = hexutil.EncodeBig(ethash.DefaultBlockReward)
