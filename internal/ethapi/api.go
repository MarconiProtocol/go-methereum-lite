...
//
// https://git.marconi.org/marconiprotocol/go-methereum-lite/wiki/Management-APIs#personal_ecRecover
...
//
// https://gitlab.neji.vm.tc/marconi/wiki/wiki/JSON-RPC#eth_sign
